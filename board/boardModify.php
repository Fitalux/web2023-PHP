    ...
    <main id="main" class="container">
        <div class="intro__inner center bmStyle">
            <picture class="intro__images small">
                ...
                <img src="../assets/img/intro01.png" alt="회원가입 이미지">
            </picture>
            <h2>게시글 수정</h2>
            <p class="intro__text">
        ...
        <div class="board__inner">
            <div class="board__write">
                <form action="boardModifySave.php" name="boardModifySave" method="post">
                    <fieldset>
                        <legend class="blind">게시글 수정</legend>
<?php
    ...
    if($result){
        ...
        echo"<div class='mt50'><label for='boardPass'>비밀번호</label><input type='password' id='boardPass' name='boardPass' class='inputStyle' autocomplete='off' required placeholder='게시글을 수정하려면 비밀번호를 입력하세요.'></div>";
    }
?>
                        <!-- <div>
